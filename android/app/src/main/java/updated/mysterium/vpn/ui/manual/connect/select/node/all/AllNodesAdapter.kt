...
class AllNodesAdapter : BaseNodeAdapter<CountryNodes, AllNodesAdapter.CountrySelectHolder>() {

    companion object {
        private const val ALL_COUNTRY_CODE = "ALL_COUNTRY"
    }

    var onCountryClickListener: ((CountryNodes) -> Unit)? = null
