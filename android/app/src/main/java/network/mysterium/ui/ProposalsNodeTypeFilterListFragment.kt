...
class ProposalsNodeTypeFilterListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_proposals_node_type_filter_list, container, false)
    }
    ...
    override fun onViewCreated(root: View, savedInstanceState: Bundle?) {
        ...
        proposalsCountryFilterResetBtn = root.findViewById(R.id.proposals_node_type_filter_reset_btn)
    ...
    private fun initList(root: View) {
        val listItems = proposalsViewModel.proposalsCountries().map { NodeTypeItem(it) }
...
data class NodeTypeItem(val country: ProposalFilterCountry) : BaseItem() {
