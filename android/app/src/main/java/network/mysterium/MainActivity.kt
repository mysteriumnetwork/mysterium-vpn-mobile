...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleConnChange(it: ConnState) {
        Log.i(TAG, "Internet connection changed: $it")

        vpnNotInternetLayout.visibility = if (it == ConnState.CONNECTED) {
            View.GONE
        } else {
            View.VISIBLE
        }
